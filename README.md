...
* `2.4.0.M3` Experimental openHAB 2.4.0.M3 Milestone version ([Dockerfile](https://github.com/openhab/openhab-docker/blob/master/2.4.0.M3/amd64/debian/Dockerfile))

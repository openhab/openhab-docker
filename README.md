...
`docker run --name openhab --net=host openhab/openhab:2.5.4`
...
`docker run --detach --name openhab openhab/openhab:2.5.4`
...
`docker run -it openhab/openhab:2.5.4`

#### Debug mode

The debug mode is started with the command:

`docker run -it openhab/openhab:2.5.4 ./start_debug.sh`

...
[![Docker Version](https://images.microbadger.com/badges/version/openhab/openhab:3.1.0.svg)](https://microbadger.com/#/images/openhab/openhab:3.1.0)
[![Docker Metadata](https://images.microbadger.com/badges/image/openhab/openhab:3.1.0.svg)](https://microbadger.com/images/openhab/openhab:3.1.0)
...
* **Milestone:** Intermediary releases of the next openHAB version which are released about once a month. They include recently added features and bugfixes and are a good compromise between the current stable version and the bleeding-edge and potentially unstable snapshot version.
  * `3.2.0.M1` ([Release notes](https://github.com/openhab/openhab-distro/releases/tag/3.2.0.M1))

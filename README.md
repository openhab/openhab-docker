...
* `2.4.0.M5` Experimental openHAB 2.4.0.M5 Milestone version ([Dockerfile](https://github.com/openhab/openhab-docker/blob/master/2.4.0.M5/debian/Dockerfile-amd64))
* `2.4.0.M6` Experimental openHAB 2.4.0.M6 Milestone version ([Dockerfile](https://github.com/openhab/openhab-docker/blob/master/2.4.0.M6/debian/Dockerfile-amd64))
* `2.4.0.M7` Experimental openHAB 2.4.0.M7 Milestone version ([Dockerfile](https://github.com/openhab/openhab-docker/blob/master/2.4.0.M7/debian/Dockerfile-amd64))
* `2.4.0-snapshot` Experimental openHAB 2.4.0 SNAPSHOT version ([Dockerfile](https://github.com/openhab/openhab-docker/blob/master/2.4.0-snapshot/debian/Dockerfile-amd64))
<!-- Generated by update.sh -->
...
If you are unsure about what your needs are, you probably want to use `openhab/openhab:2.3.0`.
...
`docker run --name openhab --net=host openhab/openhab:2.3.0`
...
`docker run --detach --name openhab openhab/openhab:2.3.0`
...
`docker run -it openhab/openhab:2.3.0`

#### Debug mode

The debug mode is started with the command:

`docker run -it openhab/openhab:2.3.0 ./start_debug.sh`

...
* `2.4.0.M7` Experimental openHAB 2.4.0.M7 Milestone version ([Dockerfile](https://github.com/openhab/openhab-docker/blob/master/2.4.0.M7/amd64/debian/Dockerfile))
